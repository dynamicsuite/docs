    ...
    return {
      options: {
        ...
        syntax_html:
            ...
            '</div>',
        events: {
          'input($event.target.value)': 'When input is registered in the component'
        },
        slots: {
        ...
        props: [
          ...
          },
          {
            ...
            required: true,
            default: 'null',
            usage: 'The value of the radio button to set on the group.'
          },
          {
            prop: 'name',
            type: 'String',
            required: true,
            default: 'null',
            usage: 'The name attribute to group the component with.'
          },
          {
            prop: 'disabled',
            type: 'Boolean',
